...
$ecms_config['db']['dbusername']='dbusername';	//数据库用户名
$ecms_config['db']['dbpassword']='123456';	//数据库密码
$ecms_config['db']['dbname']='dbname';	//数据库名
...
$ecms_config['esafe']['ecookiernd']='mMd5hlZ7J4LhgZwj3k8z8IKglqwyEIvag7Qs';	//后台登录COOKIE认证码(填写10~50个任意字符，最好多种字符组合)
...
$ecms_config['cks']['ckvarpre']='xqbxv';		//前台cookie变量前缀
$ecms_config['cks']['ckadminvarpre']='isaik';		//后台cookie变量前缀
$ecms_config['cks']['ckrnd']='a6DowlfglbjeMtEuctV93fq4gcxzGSH8Fee';	//COOKIE验证随机码(填写10~50个任意字符，最好多种字符组合)
$ecms_config['cks']['ckrndtwo']='IO3Nw8bCGWaZAQxEX3WgC0sX53vPx7wutQ';	//COOKIE验证随机码2(填写10~50个任意字符，最好多种字符组合)
$ecms_config['cks']['ckrndthree']='ZoPmt8wih4LMmb7NyuVy7ZW8JrCNr7Jax';	//COOKIE验证随机码3(填写10~50个任意字符，最好多种字符组合)
$ecms_config['cks']['ckrndfour']='ynHHbaY5oHl6vhKOqIgZ1jSg1epD8EKP';	//COOKIE验证随机码4(填写10~50个任意字符，最好多种字符组合)
$ecms_config['cks']['ckrndfive']='2qVTz6cMefarMdZb1rv3zpQeTxoxy82';	//COOKIE验证随机码5(填写10~50个任意字符，最好多种字符组合)
...
//------------e_public
$public_r=array('sitename'=>'UIkit中文网',
'newsurl'=>'/',
...
'keytog'=>2,
'keytime'=>900,
'keyrnd'=>'h9IZSFRwpCarrklBCAvgxlkGwt0B0RxD',
...
'fbkey_ok'=>0,
'newaddinfotime'=>0,
'classnavs'=>'<a href=\"/doc/\">文档</a>&nbsp;|&nbsp;<a href=\"/examples/\">布局示例</a>',
'adminstyle'=>',1,2,',
'docnewsnum'=>300,
'openschall'=>0,
'schallfield'=>1,
...
'bakescapetype'=>1,
'hkeytime'=>30,
'hkeyrnd'=>'WNtjTTlehjV2m5C2YsK5OgqP5PEWAhv11i3t',
'mhavedatedo'=>0,
'reportkey'=>0,
'ctimeopen'=>0,
'ctimelast'=>0,
...
'ctimegids'=>'',
'ctimecids'=>'',
'ctimernd'=>'IjvK2YrEhbvPza8Mip29L33FLbDKy9vHWyYBHGzpnP',
'qmadminuids'=>'',
'qmforumuids'=>'',
'qmotheruids'=>'',
'ckhavemoreport'=>0,
...
'intb'=>0,
'mid'=>8);
$etable_r['ukdoc']=Array('deftb'=>'1',
'yhid'=>0,
'intb'=>0,
'mid'=>9);
$etable_r['example']=Array('deftb'=>'1',
'yhid'=>0,
'intb'=>0,
'mid'=>10);
...
'datatbs'=>',1,',
'deftb'=>'1',
'enter'=>',title,ftitle,subnav,special.field,newstime,titlepic,smalltext,writer,befrom,newstext,',
'qenter'=>',title,ftitle,subnav,special.field,titlepic,smalltext,writer,befrom,newstext,',
'listtempf'=>',title,ftitle,newstime,titlepic,smalltext,diggtop,',
'tempf'=>',title,ftitle,subnav,newstime,titlepic,smalltext,writer,befrom,newstext,diggtop,',
'mustqenterf'=>',title,subnav,newstext,',
'listandf'=>'',
'setandf'=>0,
'searchvar'=>',title,smalltext,',
'cj'=>',title,ftitle,newstime,titlepic,smalltext,writer,befrom,newstext,',
'canaddf'=>',title,ftitle,subnav,newstime,titlepic,smalltext,writer,befrom,newstext,',
'caneditf'=>',title,ftitle,subnav,newstime,titlepic,smalltext,writer,befrom,newstext,',
'tbmainf'=>',title,titlepic,newstime,ftitle,smalltext,diggtop,',
'tbdataf'=>',writer,befrom,newstext,subnav,',
'tobrf'=>',smalltext,newstext,',
'dohtmlf'=>',ftitle,smalltext,writer,befrom,newstext,diggtop,subnav,',
'checkboxf'=>',',
'savetxtf'=>'',
'editorf'=>',newstext,',
'ubbeditorf'=>',',
...
'datatbs'=>',1,',
'deftb'=>'1',
'enter'=>',title,ftitle,muban,special.field,newstime,titlepic,smalltext,',
'qenter'=>',title,ftitle,muban,special.field,titlepic,smalltext,',
'listtempf'=>',title,ftitle,muban,newstime,titlepic,smalltext,diggtop,',
'tempf'=>',title,ftitle,muban,newstime,titlepic,smalltext,diggtop,',
'mustqenterf'=>',title,muban,',
'listandf'=>'',
'setandf'=>0,
'searchvar'=>',title,smalltext,',
'cj'=>',title,ftitle,newstime,titlepic,smalltext,',
'canaddf'=>',title,ftitle,muban,newstime,titlepic,smalltext,',
'caneditf'=>',title,ftitle,muban,newstime,titlepic,smalltext,',
'tbmainf'=>',title,titlepic,newstime,ftitle,smalltext,diggtop,muban,',
'tbdataf'=>',writer,befrom,newstext,',
'tobrf'=>',smalltext,newstext,',
'dohtmlf'=>',ftitle,smalltext,writer,befrom,newstext,diggtop,muban,',
'checkboxf'=>',',
'savetxtf'=>'',
'editorf'=>',newstext,',
'ubbeditorf'=>',',
