...
E_D("DROP TABLE IF EXISTS `phome_ecms_infoclass_example`;");
E_C("CREATE TABLE `phome_ecms_infoclass_example` (
  ...
  `zz_muban` text NOT NULL,
  `z_muban` varchar(255) NOT NULL,
  `qz_muban` varchar(255) NOT NULL,
  `save_muban` varchar(10) NOT NULL,
  PRIMARY KEY (`classid`)
