...
E_D("DROP TABLE IF EXISTS `phome_ecms_infoclass_ukdoc`;");
E_C("CREATE TABLE `phome_ecms_infoclass_ukdoc` (
  ...
  `zz_subnav` text NOT NULL,
  `z_subnav` varchar(255) NOT NULL,
  `qz_subnav` varchar(255) NOT NULL,
  `save_subnav` varchar(10) NOT NULL,
  PRIMARY KEY (`classid`)
