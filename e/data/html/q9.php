...
</td></tr><tr><td width='16%' height=25 bgcolor='ffffff'>子导航代码</td><td bgcolor='ffffff'><textarea name="subnav" cols="60" rows="10" id="subnav"><?=$ecmsfirstpost==1?"":DoReqValue($mid,'subnav',stripSlashes($r[subnav]))?></textarea>
