...
</td></tr><tr><td width='16%' height=25 bgcolor='ffffff'>模板代码</td><td bgcolor='ffffff'>
<textarea name="muban" cols="60" rows="10" id="muban"><?=$ecmsfirstpost==1?"":DoReqValue($mid,'muban',stripSlashes($r[muban]))?></textarea>
