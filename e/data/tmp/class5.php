...
<li><a href="/doc/v3/" style="text-decoration:underline" target="_blank">UIkit 3 预览</a></li>
                </ul>
                ...
                <div class="uk-grid tm-grid-margin-large" data-uk-grid-match="{target:'.uk-panel'}" data-uk-grid-margin>
                    ...
                    <div class="uk-width-medium-1-3">
                        <a class="uk-panel tm-panel-link" href="http://getuikit.net/warp/" >
                            <div class="tm-icon"><img src="//getuikit.net/warp/images/logo2.svg"/></div>
                            <h2>Warp 主题框架</h2>
                    ...
                    <div class="uk-width-medium-1-3">
                        <a class="uk-panel tm-panel-link" href="http://slimphp.net/" target="_blank">
                            <div class="tm-icon"><img src="/docs/images/favicon.png"/></div>
                            <h2>Slim 框架</h2>
        ...
        <div class="tm-footer">
            <div class="uk-container uk-container-center uk-text-center">
                ...
                <div class="uk-panel">
                    <p>Made by <a href="http://www.yootheme.com" rel="nofollow">YOOtheme</a> with love and caffeine.<br class="uk-hidden-small">Licensed under <a href="http://opensource.org/licenses/MIT" rel="nofollow">MIT license</a>.<br>由<a href="/">UIkit中文网</a>翻译</p>
...
(function() {
  ...
  hm.src = "https://hm.baidu.com/hm.js?9431dd8aad5a32e36edbfe4c279d0f02";
